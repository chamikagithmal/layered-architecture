...
public class ItemDAOImpl implements ItemDAO {
    ...
    public boolean save(ItemDTO dto) throws SQLException, ClassNotFoundException {
        ...
        return i>0;
        //return SQLUtil.execute("INSERT INTO Item (code, description, unitPrice, qtyOnHand) VALUES (?,?,?,?)",dto.getDescription(),dto.getUnitPrice(),dto.getQtyOnHand(),dto.getCode());
    }
